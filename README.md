...
|------------|----------|-------------|-----------|
| BOOT1 | 1 | Push button switch, generic | Button Switch SMD:SW Push 1P1T NO E-Switch |
| C1, C2, C5, C3, C4 | 5 | Unpolarized capacitor | Capacitor SMD:C 0603 1608Metric Pad1.08x0.95 |
| C10 | 1 | Unpolarized capacitor | Capacitor SMD:C 0603 1608Metric Pad1.08x0.95 |
| SN65220 | 1 | | |
| D1 | 1 | 40V 600mV@1A 1A SOD-323 | Diode SMD:D SOD-323 |
| D2 | 1 | SS34 05 20 | |
| D4 | 1 | Light emitting diode | LED_SMD:LED_0805_2012Metric_Pad1.15x1.40m |
| J1 | 1 | Generic connector, single row | Connector PinHeader_1.00mm:PinHeader_1x08_P |
| Vbus1 | 1 | Conn 01x08 Pin | |
| Borneras | 2 | bornera | |
| J5 | 1 | Conn 01x04 Pin | |
| J3, J2 | 2 | Generic connector, single row | Connector PinSocket 1.00mm:PinSocket 1x11 P1 |
| R7 | 1 | Resistor | Resistor SMD:R 1206 3216Metric Pad1.30x1.75m |
| R4 | 1 | Resistor | Resistor SMD:R 1206 3216Metric Pad1.30x1.75m |
| R6, R5, R3 | 3 | Resistor | Resistor SMD:R 0603 1608Metric Pad0.98x0.95m |
| RST1 | 1 | Push button switch, generic | Button Switch SMD:SW Push 1P1T_NO_ESwitch |
...
![visualizacion datos](images/G3.png)
